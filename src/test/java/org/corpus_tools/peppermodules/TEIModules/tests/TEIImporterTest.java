 ...
 * {@link TEIImporter} class. Feel free to adapt and enhance this test class for
 * real tests to check the work of your importer. If you are not confirm with
 * JUnit, please have a look at <a
...
public class TEIImporterTest extends PepperImporterTest {
	...
	public void testPrimaryText() throws XMLStreamException, FileNotFoundException {
		...
		getFixture().getProperties().setPropertyValue(TEIImporterProperties.PROP_TOKEN_TOKENIZATION_DEFAULTTAG, true);
